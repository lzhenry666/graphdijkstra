...
var Developer = function (_Person) {
  ...
  function Developer(name, age) {
    var occupation = arguments.length <= 2 || arguments[2] === undefined ? DEFAULT_OCCUPATION : arguments[2];

    _classCallCheck(this, Developer);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(Developer).call(this, name, age));
